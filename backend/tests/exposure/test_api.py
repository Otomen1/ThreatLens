"""Tests for GET /api/v1/exposure — the Phase 5.0 framework-status placeholder."""
...
from threatlens.exposure import EXPOSURE_FRAMEWORK_VERSION
...
def test_reports_zero_providers_in_phase_5_0() -> None:
