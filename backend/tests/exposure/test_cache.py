"""Tests for InMemoryExposureCache (the only concrete cache in Phase 5.0)."""
...
class TestBasicOperations:
    def test_get_missing_key_returns_none(self) -> None:
        cache: InMemoryExposureCache[str] = InMemoryExposureCache()
...
class TestTtlExpiry:
    def test_value_available_before_ttl_elapses(self) -> None:
        ...
        cache: InMemoryExposureCache[str] = InMemoryExposureCache(clock=clock)
